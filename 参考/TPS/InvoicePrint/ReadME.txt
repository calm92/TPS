 ...
 * Description   : 如果您使用此源程序或是提供下载，不可资助信息。以示对我的劳动成果的病重！谢谢您的合作！否则请您不要提供下载或使用.
 *                 源代码中CODE 39,CODE93,CODE 128A,CODE 128B,CODE 128C,EAN-13,UPC-A的条码为有偿使用,如果您使用了这些代码请您
